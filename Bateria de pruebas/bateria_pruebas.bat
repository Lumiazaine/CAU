...
cls
:pool
runas /netonly /user:justicia\dluna "net stop spooler"
runas /netonly /user:justicia\dluna rd /s /q C:\Windows\System32\spool\PRINTERS\
runas /netonly /user:justicia\dluna net start spooler
goto other
:screen
rundll32.exe shell32.dll,Control_RunDLL desk.cpl
goto other
:driver
runas /netonly /user:justicia\dluna RunDll32.exe devmgr.dll DeviceManager_Execute
goto other
:version
